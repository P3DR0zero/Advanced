...
const char* mqtt_server = "80ab9d4b47a140b5b15d1827591ab3ac.s1.eu.hivemq.cloud"; // AQUI MUDAREMOS PARA O SERVER MQTT DA UFRN
const int mqtt_port = 8883; // PORTA MQTT - MUDAR PARA DA UFRN
const char* mqtt_user = "ESP32";
const char* mqtt_pass = "Testeesp1";
...
void setup() {
  ...
  // Ignora verificação TLS temporariamente
...
void loop() {
  ...
  if (tempo_atual - tempo_anterior >= intervalo) {
    ...
    client.publish("ESP32/EIXO_Z", payload);
  }
}
